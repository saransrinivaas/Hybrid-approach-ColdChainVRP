              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '0.75rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    {results && (
                      <span
                        className={`solver-badge ${(!stitchedComparison || stitchedComparison.converged) ? 'ok' : 'unsubmitted'}`}
                        style={{
                          background: (!stitchedComparison || stitchedComparison.converged) ? 'rgba(16, 185, 129, 0.12)' : 'rgba(239, 68, 68, 0.08)',
                          border: (!stitchedComparison || stitchedComparison.converged) ? '1px solid rgba(16, 185, 129, 0.3)' : '1px solid rgba(239, 68, 68, 0.25)',
                          color: (!stitchedComparison || stitchedComparison.converged) ? '#10b981' : '#ef4444',
                      ...
                      >
                        {stitchedComparison
                          ? (stitchedComparison.converged ? 'PERFECT MATCH' : 'NOISE DETECTED')
                          : 'CONVERGED'}
                      </span>
                    )}
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                    ...
                    {stitchedComparison && (
                      <div style={{
                        ...
                        background: stitchedComparison.converged ? 'rgba(16, 185, 129, 0.04)' : 'rgba(239, 68, 68, 0.03)',
                        border: `1px solid ${stitchedComparison.converged ? 'rgba(16, 185, 129, 0.25)' : 'rgba(239, 68, 68, 0.25)'}`,
                        borderRadius: '8px',
                        padding: '1.2rem',
                        display: 'flex',
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', borderBottom: '1px solid rgba(255,255,255,0.06)', paddingBottom: '0.4rem' }}>
                          <h4 style={{ margin: 0, fontSize: '1.12rem', fontWeight: 800, color: '#fff' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(13rem, 1fr))', gap: '1rem' }}>
                          {/* Simulator Stitch */}
                          <div style={{ background: '#18181b', border: '1px solid rgba(255,255,255,0.03)', borderRadius: '6px', padding: '0.75rem', minHeight: '13.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                            <div>
                          ...
                          {/* Hardware Stitch */}
                          <div style={{ background: '#18181b', border: `1px solid ${stitchedComparison.converged ? 'rgba(16, 185, 129, 0.2)' : 'rgba(239, 68, 68, 0.15)'}`, borderRadius: '6px', padding: '0.75rem', minHeight: '13.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                            <div>
                              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.74rem', marginBottom: '0.5rem', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '0.25rem' }}>
  ...
  return (
    <div className="hardware-tab-wrapper animate-fade-in" style={{ padding: '0.5rem 0' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '1.5rem' }}>
          <div style={{ flex: '1 1 30rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.35rem' }}>
              <h2 style={{ margin: 0, fontSize: '1.75rem', fontWeight: 800, letterSpacing: '-0.02em', color: '#fff' }}>
                Quantum VRP Hardware Evaluation
              </h2>
            </div>
            <p style={{ margin: 0, fontSize: '0.92rem', color: '#aaa', lineHeight: '1.4' }}>
              We have run the evaluations on physical quantum hardware, and here are the results for comparison and understanding.
            </p>
          </div>
      ...
      <div style={{
        ...
        {[
          { id: 'scenarios', label: 'VRP Scenario Comparisons (4-Node)' },
          { id: 'scenarios-node3', label: 'VRP Sub-cluster Fine-Tuning (3-Node)' },
          { id: 'scaling', label: 'Qubit Scaling & Phase Noise' },
          { id: 'optimizer', label: 'QAOA Parameter Sweeps' },
          { id: 'compiler', label: 'Compiler & Mitigation sweeps' },
          { id: 'cache', label: 'Cache & Cloud Job Ledger' }
        ].map(sub => (
          <button
            key={sub.id}
            ...
            {isLoadingSweeps ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                  ...
                  <div style={{ padding: '1.75rem', borderRadius: '8px', background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
                    <h4 style={{ margin: '0 0 1rem 0', fontSize: '1.3rem', color: '#fff', fontWeight: 700 }}>
                      Transpilation Optimization Sweeps
                    </h4>
                    <table style={{ width: '100%', fontSize: '1rem', borderCollapse: 'collapse', textAlign: 'left', marginBottom: '0.75rem' }}>
                      <thead>
                        <tr style={{ background: '#1a1a1a', borderBottom: '1px solid rgba(255,255,255,0.05)', color: '#888' }}>
                          <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Optimization Level</th>
                          <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Gate Depth</th>
                          <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>CNOT Count</th>
                          <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Fidelity</th>
                          <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Compiler Latency</th>
                        </tr>
                      </thead>
                      <tbody>
                        {sweepResults.optimization_levels.map((r, i) => (
                          <tr key={i} style={{ borderBottom: '1px solid #1e1e1e', background: r.optimization_level === 3 ? 'rgba(255, 255, 255, 0.06)' : 'transparent' }}>
                            <td style={{ padding: '0.75rem 0.6rem', fontWeight: r.optimization_level === 3 ? 700 : 400 }}>
                              Level {r.optimization_level} {r.optimization_level === 3 ? '(Recommended)' : ''}
                            </td>
                            <td style={{ padding: '0.75rem 0.6rem', fontFamily: 'monospace' }}>{r.depth}</td>
                            <td style={{ padding: '0.75rem 0.6rem', fontFamily: 'monospace' }}>{r.cnot_count}</td>
                            <td style={{ padding: '0.75rem 0.6rem', color: r.fidelity > 0.8 ? '#10b981' : '#fbbf24', fontWeight: 700 }}>
                              {(r.fidelity * 100).toFixed(0)}%
                            </td>
                            <td style={{ padding: '0.75rem 0.6rem', color: '#666' }}>{r.compile_time.toFixed(2)}s</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                    <p style={{ margin: 0, fontSize: '0.95rem', color: '#888', lineHeight: '1.5', background: '#1a1a1a', padding: '0.65rem 0.75rem', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <div style={{ padding: '1.75rem', borderRadius: '8px', background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
                    ...
                    <table style={{ width: '100%', fontSize: '1rem', borderCollapse: 'collapse', textAlign: 'left', marginBottom: '0.75rem' }}>
                      <thead>
                        <tr style={{ background: '#1a1a1a', borderBottom: '1px solid rgba(255,255,255,0.05)', color: '#888' }}>
                          <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Mitigation Filter</th>
                          <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Fidelity</th>
                          <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Sync Overhead</th>
                          <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>VRP Status</th>
                        </tr>
                      </thead>
                      <tbody>
                        {sweepResults.error_mitigations.map((r, i) => (
                          <tr key={i} style={{ borderBottom: '1px solid #1e1e1e', background: r.strategy.includes('Complete') ? 'rgba(16, 185, 129, 0.06)' : 'transparent' }}>
                            <td style={{ padding: '0.75rem 0.6rem', fontWeight: r.strategy.includes('Complete') ? 700 : 400 }}>
                              {r.strategy}
                            </td>
                            <td style={{ padding: '0.75rem 0.6rem', color: r.fidelity > 0.8 ? '#10b981' : '#fbbf24', fontWeight: 700, fontFamily: 'monospace' }}>
                              {(r.fidelity * 100).toFixed(0)}%
                            </td>
                            <td style={{ padding: '0.75rem 0.6rem', fontFamily: 'monospace' }}>+{r.qpu_overhead_sec.toFixed(2)}s</td>
                ...
                <div style={{ padding: '1.75rem', borderRadius: '8px', background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <table style={{ width: '100%', fontSize: '1rem', borderCollapse: 'collapse', textAlign: 'left', marginBottom: '0.75rem' }}>
                    <thead>
                      <tr style={{ background: '#1a1a1a', borderBottom: '1px solid rgba(255,255,255,0.05)', color: '#888' }}>
                        <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Qubit Entanglement Map</th>
                        <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Gate Depth</th>
                        <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>CNOT Count</th>
                        <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Physical Fidelity</th>
                        <th style={{ padding: '0.75rem 0.6rem', fontSize: '0.95rem' }}>Description & Recommendation</th>
                      </tr>
                    </thead>
                    <tbody>
                      {sweepResults.entanglement_topologies.map((r, i) => (
                        <tr key={i} style={{ borderBottom: '1px solid #1e1e1e', background: r.topology === 'Linear' ? 'rgba(255, 255, 255, 0.06)' : 'transparent' }}>
                          <td style={{ padding: '0.75rem 0.6rem', fontWeight: r.topology === 'Linear' ? 700 : 400, color: r.topology === 'Linear' ? '#ffffff' : '#cbd5e1' }}>
                            {r.topology} {r.topology === 'Linear' ? '(Recommended)' : ''}
                          </td>
                          <td style={{ padding: '0.75rem 0.6rem', fontFamily: 'monospace' }}>{r.gate_depth}</td>
                          <td style={{ padding: '0.75rem 0.6rem', fontFamily: 'monospace' }}>{r.cnot_count}</td>
                          <td style={{ padding: '0.75rem 0.6rem', color: r.fidelity > 0.8 ? '#10b981' : r.fidelity > 0.6 ? '#fbbf24' : '#ef4444', fontWeight: 700 }}>
                            {(r.fidelity * 100).toFixed(0)}%
                          </td>
                          <td style={{ padding: '0.75rem 0.6rem', color: '#aaa', fontSize: '0.95rem' }}>{r.note}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
